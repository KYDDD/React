...
function App() {
  ...
  const handleAddressChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    //   if (address.id === Number(event.target.id)) {
    //     //바꿔야하는주소
    ...
    console.log("집", user.extra.addressBook[1] === newUser.extra.addressBook[1]); //false
    console.log("집 주소", user.extra.addressBook[1].value === newUser.extra.addressBook[1].value); //false
